	...
	<div class="space-y-10 text-center flex flex-col items-center w-screen">
		...
		>
			...
			<div class="">
				...
				<footer class="w-full flex-col justify-between items-center py-8 m-4 sticky flex px-16 variant-glass-success rounded-2xl">
					<div class="flex flex-col gap-y-2">
						<h2 class="text-surface-400 font-light italic text-sm">by Adrian Tam</h2>
					...
					<div class="flex flex-col gap-y-2">
						...
						<a
							href="https://github.com/kayeungadrian-tam/Svelte_Assistance"
							target="_blank"
